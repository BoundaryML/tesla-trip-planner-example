...
class BamlSyncClient:
    ...
    def GetTrip(
      ...
      return cast(types.Trip, raw.cast_to(types, types))
...
class BamlStreamClient:
    ...
    def GetTrip(
        ...
        message: str,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlSyncStream[partial_types.Trip, types.Trip]:
      __tb__ = baml_options.get("tb", None)
      if __tb__ is not None:
        tb = __tb__._tb # type: ignore (we know how to use this private attribute)
      else:
      ...
      return baml_py.BamlSyncStream[partial_types.Trip, types.Trip](
        raw,
        lambda x: cast(partial_types.Trip, x.cast_to(types, partial_types)),
        lambda x: cast(types.Trip, x.cast_to(types, types)),
        self.__ctx_manager.get(),
      )
